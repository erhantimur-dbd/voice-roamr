...
export const INTEGRATIONS = [
  { id: "gmail", name: "Gmail", group: "Google", status: "live", blurb: "Read, draft, and send from the agent’s voice.", connector: "Gmail" },
  { id: "gcal", name: "Google Calendar", group: "Google", status: "live", blurb: "Check availability and book while on the call.", connector: "GoogleCalendar" },
  { id: "gdrive", name: "Google Drive", group: "Google", status: "live", blurb: "Ground answers in Docs, Sheets and PDFs.", connector: "GoogleDrive" },
  { id: "gsheets", name: "Google Sheets", group: "Google", status: "live", blurb: "Log leads and tickets as rows.", connector: "GoogleDrive" },
  { id: "gcontacts", name: "Google Contacts", group: "Google", status: "live", blurb: "Resolve who is calling.", connector: "Gmail" },
  { id: "meet", name: "Google Meet", group: "Google", status: "live", blurb: "Spin up a Meet link mid-call.", connector: "GoogleCalendar" },
  { id: "outlook", name: "Outlook", group: "Microsoft", status: "coming", blurb: "Mail and calendar for Microsoft 365 shops.", connector: "Outlook" },
  { id: "teams", name: "Microsoft Teams", group: "Microsoft", status: "coming", blurb: "Post a summary into the right channel.", connector: "MicrosoftTeams" },
  { id: "hubspot", name: "HubSpot", group: "CRM", status: "coming", blurb: "Create contacts, deals and notes from the call." },
  { id: "salesforce", name: "Salesforce", group: "CRM", status: "coming", blurb: "Log activity against the account." },
  { id: "stripe", name: "Stripe", group: "Payments", status: "coming", blurb: "Take a card, send a link, check an invoice." },
  { id: "shopify", name: "Shopify", group: "Commerce", status: "coming", blurb: "Order status, refunds, tracking." },
  { id: "zendesk", name: "Zendesk", group: "Support", status: "coming", blurb: "Open and update tickets as you speak." },
  { id: "notion", name: "Notion", group: "Knowledge", status: "coming", blurb: "Use your Notion wiki as the knowledge base." },
  { id: "slack", name: "Slack", group: "Collab", status: "coming", blurb: "Page a human in Slack when it matters." },
  { id: "calendly", name: "Calendly", group: "Scheduling", status: "coming", blurb: "Offer the next open slot, booked live." },
  { id: "twilio", name: "Twilio", group: "Telephony", status: "coming", blurb: "Local numbers for your voice agents." },
  { id: "whatsapp", name: "WhatsApp", group: "Messaging", status: "coming", blurb: "Roamr WhatsApp Business account only — later." },
  { id: "zapier", name: "Zapier", group: "Automation", status: "coming", blurb: "Automations from a tool call." },
  { id: "webhook", name: "Webhooks", group: "Developers", status: "coming", blurb: "POST events to your own backend." },
  { id: "mcp", name: "Custom MCP", group: "Developers", status: "coming", blurb: "Attach your own tools over MCP.", connector: "Mcp" },
] as const;
