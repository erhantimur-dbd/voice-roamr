  ...
  return (
    <SiteShell>
      ...
      <div className="mx-auto max-w-3xl space-y-5 px-4 py-14 text-base text-muted sm:px-6">
        <p>
          Roamr started as a travel company. The same brief still holds: stay reachable wherever life takes you. The product is now a self-serve voice-agent platform on Grok 2.0 voice — personal assistants, sales floors and support desks that pick up in twenty-three languages.
        </p>
        <p>
